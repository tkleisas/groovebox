...
| Index | Note | Key |
|---|---|---|
| 0–15 | 36–51 | white keys 1–16 (piano row, always playable) |
| 16–26 | 52–62 | black keys, left to right (C♯ pattern order) |
| 27–29 | 63–65 | transport: PLAY, STOP, REC |
| 30 | 66 | joystick push |
| 31 | 67 | MODE (keyboard scale-lock toggle) |
| 32, 33 | 68, 69 | < , > |
| 34–37 | 70–73 | soft keys S1–S4 |
| 38, 39 | 74, 75 | SHIFT-L, SHIFT-R |
| 40–55 | 76–91 | **step row 1–16** (rev B: dedicated sequencer row under the piano) |

Both shifts are logically identical; the brain may merge them.
...
| 20 | pot CUTOFF |
| 21 | pot RESONANCE |
| 22–25 | ~~pots ATTACK/DECAY/SUSTAIN/RELEASE~~ — removed in rev B2 (ADSR moved to encoders 5–8); reserved |
...
| CC | Source |
|---|---|
| 16–23 | encoder 1–8 rotation: two's-complement relative (64 = no movement, 65 = +1 detent, 63 = −1 detent). Encoders 5–8 = amp-ENV A/D/S/R (rev B2) |
| 32–39 | encoder 1–8 push: 127 on press, 0 on release |

## Brain → panel (LEDs, channel 2)

Note On/Off on channel 2. Notes 0–15 = **step-row LEDs**, 16–31 =
**white-key LEDs** (NSR-1 rev B). Velocity ignored for rev A (single
intensity); velocities 1–127 may later map to PWM brightness.
...
| 0x01–0x02 | pot 0–1: CUTOFF / RESONANCE (the CC 20–21 sources) |
| 0x03–0x06 | legacy rev A pots — clamp to the nearest real pot (rev B2: only two pots exist) |
